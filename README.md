...
### 22 Frameworks Across 8 Categories

This knowledge base contains 22 proven product marketing frameworks, organised by where they apply in the product marketing workflow.
...
- **[INDEX.md](INDEX.md)** — Full taxonomy; all 22 frameworks with one-line descriptions
...
- **Total Frameworks:** 22 (all validated and cross-linked); 9 additional candidates identified pending review (see [FRAMEWORK-BACKLOG.md](FRAMEWORK-BACKLOG.md))
