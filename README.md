...
### 63 Entries Across 9 Categories, Plus a Concepts Area

This knowledge base contains 63 proven product marketing entries (28 frameworks, 26 methodologies, 8 models, and 1 primer), organised by where they apply in the product marketing workflow. Each entry declares a **Type** (Framework, Methodology, Model, or Primer); see [CLAUDE.md](CLAUDE.md) for what each type means.
...
| 6 | Product Experience & Adoption | 6 | `frameworks/06-product-experience-adoption.md` |
...
- **[NEW-SOURCES-GAP-ANALYSIS.md](NEW-SOURCES-GAP-ANALYSIS.md)**: Candidate queue sourced from the PMA Advanced course index and calven.ai; first 3 (MAP Model, RFM Model, MaxDiff Analysis) built 2026-08-14, 5 remain queued, 1 flagged weak/hold (logged 2026-08-14)
