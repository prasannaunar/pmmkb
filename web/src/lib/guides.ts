...
export function pathQuiz(guide: Guide): {
  ...
  > = {
    foundations: [
      [
        ...
        "Create a messaging house that assigns every commercial decision to PMM.",
        "Clarify ownership for launches only, leaving other GTM decisions unresolved.",
        "Adopt a launch checklist to define the PMM role going forward.",
      ],
      [
        ...
        "Keep serving both audiences, and shorten the statement until it fits one paragraph.",
        "Write a messaging pillar for every important feature so both groups feel covered.",
        "Ask sales to pick whichever audience is easiest to sell to in the moment.",
      ],
      [
        ...
        "Broaden the target segment until more prospects recognise the tested message.",
        "Create separate campaign headlines before the competitive alternative has even been settled.",
        "Set the launch tier first to decide what the product should ultimately stand for.",
      ],
      [
        ...
        "A new target segment for every campaign so each claim gets its own audience.",
        "A new positioning statement for every channel to maximise message variation.",
      ...
      [
        ...
        "Shorten every headline while leaving the same audience assumption in place.",
        "Produce a new sales deck to standardise the existing, unvalidated message.",
      ],
    ],
    "positioning-to-messaging": [
      [
        ...
        "Use FAB to rewrite every feature before any alternatives are even discussed.",
        "Test headline punctuation with buyers before the value claim itself is settled.",
        "Create more messaging pillars so every internal opinion feels accommodated.",
      ],
      [
        ...
        "Run the positioning workshop again for each individual asset.",
      ...
      [
        ...
        "Choose the draft that receives the most votes in an internal stakeholder review.",
        "Add more features to the draft to reflect nearly every customer use case.",
        "Ship the draft now and judge its meaning later from page-view volume alone.",
      ],
      [
        ...
        "Keep the same claim, but make the existing headline noticeably shorter.",
        "Add more brand adjectives to the headline to increase its distinctiveness.",
        "Move the unchanged claim onto a new page layout without revising it.",
      ],
    ],
    "launch-with-confidence": [
      [
        ...
        "The GTM Motion Model to choose how many launch assets get produced.",
        "STP to select a larger audience that justifies the existing planned effort.",
        "A pre-mortem to approve the resource commitment already agreed for this launch.",
      ],
      [
        ...
        "Choose the tier again, this time based on projected audience size alone.",
        "Choose the highest-reach channel available before deciding who should buy.",
        "Write a positioning statement broad enough to cover the entire market.",
      ],
      [
        ...
        "Raise the launch tier so the self-serve motion gets a larger promotional budget.",
        "Keep the existing motion in place and add more messaging pillars around it.",
        "Run a pre-mortem, but only after the first launch results have come in.",
      ],
      [
        ...
        "Use STP again to write a detailed activity list for every team involved.",
        "Use the launch tier alone as a substitute for a genuine execution plan.",
        "Use the positioning statement to assign every team its operational deadline.",
      ],
      [
        ...
        "Wait for post-launch results before discussing any failure scenarios.",
        "Change the target segment now, avoiding a review of the existing plan.",
        "Increase promotion spend to compensate for unidentified execution risks.",
      ],
    ],
  };
  ...
  const reasons: Record<string, string[][]> = {
    foundations: [
      [
        "A messaging house structures claims and proof across teams; it does not assign commercial ownership.",
        "This clarifies ownership only for launches, a narrower slice of GTM, leaving the fuller cross-functional question unresolved.",
        "A launch checklist covers only part of product marketing's scope; it does not define the full role.",
      ],
      [
        "Shortening the wording cannot reconcile audiences whose needs genuinely conflict.",
        "Listing more features for every persona avoids choosing whose needs matter most.",
        "Leaving targeting to whichever conversation is easiest prevents a shared positioning decision.",
      ],
      [
        "Broadening the audience makes an already vague position even less specific.",
        "Campaign headlines still depend on the underlying competitive position being resolved first.",
        "Launch tiering determines the scale of effort, not what the product stands for.",
      ],
      [
        "Creating a segment per campaign fragments the single audience the team already agreed.",
        "A new position per channel undermines the consistency the team is trying to build.",
        "More campaigns at the current volume only multiply the inconsistent claims.",
      ],
      [
        "Proof points do not establish whether the underlying audience choice was ever right.",
        "Shorter headlines leave the same unvalidated audience assumption fully intact.",
        "A new deck simply standardises the same unsupported audience choice more broadly.",
      ],
    ],
    "positioning-to-messaging": [
      [
        "FAB translates a feature into an outcome; it cannot replace the earlier positioning decision.",
        "Punctuation testing cannot establish why a buyer should switch in the first place.",
        "More pillars accommodate internal disagreement without resolving the underlying position.",
      ],
      [
      ...
      [
        ...
        "Renaming the category does not explain what the capability actually enables.",
        "Removing the proof point makes the benefit less credible, not more.",
      ],
      [
        "Internal votes show what stakeholders prefer, not what buyers actually understand.",
        "More features increase complexity without testing whether buyers comprehend the message.",
        "Page views measure traffic, not whether the intended message was understood.",
      ],
      [
        "The headline is already clear; brevity alone does not create a reason to switch.",
        "Brand adjectives add assertion rather than differentiated, evidenced value.",
        "A new layout leaves the weak value claim exactly as unresolved as before.",
      ],
    ],
    "launch-with-confidence": [
      [
        "The GTM Motion Model selects the acquisition approach, not the scale of launch effort.",
        "Targeting should reflect real evidence, not be inflated to justify a preselected budget.",
        "A pre-mortem surfaces risk; tiering is what establishes proportionate scope in the first place.",
      ],
      [
        "Revisiting the tier by audience size alone skips the actual missing decision: who the audience is.",
        "Channel reach cannot substitute for first deciding which buyers the launch should serve.",
        "A statement broad enough for the entire market resolves nothing about who is actually targeted.",
      ],
      [
        "More promotional budget cannot fix a motion that does not match how this buying process works.",
        "Messaging pillars do not remove the needs of a buying committee the current motion ignores.",
        "Waiting for results misses the chance to correct the motion before the budget is spent.",
      ],
      [
        "STP defines the audience and position; it does not supply the operational phases and gates.",
        "A launch tier sets the scale of effort; it does not supply the shared phases or decision gates.",
        "A positioning statement explains the value claim, not the operational deadlines behind it.",
      ],
      [
        "Waiting turns risks that were preventable now into recovery work later.",
        "Changing the segment without evidence sidesteps reviewing the plan that is already in question.",
        "More promotion spend can amplify an execution problem rather than fix it.",
      ],
    ],
  };
  return {
