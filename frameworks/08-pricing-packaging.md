...
**Pitfalls:**
- **Treating stated purchase intent as a guarantee of actual behaviour.** Respondents answering a hypothetical question about a hypothetical price tend to overstate their true willingness to buy, particularly at low prices where saying yes costs them nothing. Recovery: apply a standard conservatism discount to the top-box responses (many practitioners discount "definitely would buy" to 60-80% of its stated value based on historical calibration), and validate the recommended price with a smaller live test, an actual price change on a subset of new customers or a specific cohort, before rolling it out fully.
