...
**Benchmarks:** For context, typical SaaS NPS benchmarks are: world-class (NPS above 50), good (40 to 50), acceptable (30 to 40), and at-risk (below 30). A mid-market NPS of 60 is world-class; an SMB score of 15 and an Enterprise score of 50 suggest the two segments need very different strategies rather than a single company-wide initiative. By segment, enterprise software typically averages NPS 25 to 35, mid-market SaaS 40 to 50, and SMB or self-service products 30 to 45, so compare your own segment scores against the right band rather than a single blended industry average.
