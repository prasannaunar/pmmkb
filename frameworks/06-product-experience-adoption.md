...
2. **Cross-reference NPS Promoters and strong win/loss interview subjects against that audit**, and build or upgrade a simple tracking system (a CRM field or a shared spreadsheet is enough at first) recording who has been asked, for what, and when, so no account is approached beyond an agreed annual cap unnoticed.
