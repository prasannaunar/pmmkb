...
0. **Start from [ENRICHMENT-PLAN.md](ENRICHMENT-PLAN.md) (logged 2026-07-21).** It proposes a further set of candidate frameworks *and methodologies* (VoC programme, Dunford positioning process, message architecture, competitive battlecards, GTM motion model, PLG, conjoint analysis, sales enablement content, a GTM-vs-PMM primer, and more) and, crucially, a plan for documenting methodologies consistently in a framework-first KB. **Do Part B (content-type vocabulary and templates in CLAUDE.md) before or alongside building the first Part A candidate.** Recommended first batch: Message Architecture, Competitive Battlecard, Voice of the Customer, Dunford 10-Step Positioning Process, and the GTM-vs-PMM primer.
