...
0. **Build out [ENRICHMENT-PLAN.md](ENRICHMENT-PLAN.md) (logged 2026-07-21; build approved; 14 of 19 built).** All five "High" candidates are done: A11 Message Architecture (Category 2), A6 Voice of the Customer Programme (Category 1), A17 Competitive Battlecard Framework (Category 3), A9 Dunford's 10-Step Positioning Process (Category 2), and A5 the GTM Strategy vs Product Marketing primer (new `concepts/` area). All eight "Medium" candidates are also done: A1 GTM Motion Model (Category 4), A2 Product-Led Growth (Category 4), A7 JTBD Switch Interview Method (Category 1), A14 Conjoint Analysis (Category 8), A18 Buyer's Journey Content Map (Category 5), A3 ICP Development Methodology (Category 1), A8 Kano Model (Category 6), and A13 Command of the Message (Category 2). The "Lower" batch has opened with A4 Bullseye Framework (Category 4). The remaining 5 candidates (A10, A12, A15, A16, A19) will be built and added to the system, starting with A10 the Perceptual Map, then working top-down through the rest of the "Lower" priority tier; the priority column in the plan is the build order, not a filter. Stand up a new Category 9 (Sales Enablement) once A19 joins A17 (Category 3) and A18 (Category 5) there. Still outstanding from Part B: the `**Type:**` backfill on the original 26 entries and the Type-column rollout across all INDEX.md and README.md tables (the fourteen new entries are typed in their files and inline in INDEX.md).
