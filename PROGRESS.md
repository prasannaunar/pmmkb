...
- Number of entries: 38 ✅ (26 as of 2026-07-19; +2 on 2026-07-21 with Message Architecture in Category 2 and the Voice of the Customer Programme in Category 1; +2 on 2026-07-22 with the Competitive Battlecard Framework in Category 3 and Dunford's 10-Step Positioning Process in Category 2; +2 later on 2026-07-22 with the GTM Strategy vs Product Marketing primer in the new `concepts/` area and the GTM Motion Model in Category 4; +2 later still on 2026-07-22 with the JTBD Switch Interview Method in Category 1 and Product-Led Growth in Category 4; +2 on 2026-07-23 with Conjoint Analysis in Category 8 and the Buyer's Journey Content Map in Category 5; +2 later on 2026-07-23 with the ICP Development Methodology in Category 1 and the Kano Model in Category 6. Of the 38, 30 are tagged/treated as frameworks, 6 as methodologies, 1 as a model, and 1 as a primer; the 10 existing entries that are really methodologies, per ENRICHMENT-PLAN.md B2, are not yet retagged)
- Entries with all required sections populated for their type: 38/38 ✅ (100%; all twelve new entries follow the Framework, Methodology, Model, and Primer templates respectively)
- Entries with specific (named or detailed scenario) examples: 37/38 ✅ (the primer does not require an example per CLAUDE.md's Primer template; the other 37 all carry one)
- Entries within the word target (1000-1500 for frameworks/methodologies/models, 500-1000 for primers): 38/38 ✅ (100%; Message Architecture 1,085 words, VoC Programme 1,114 words, Competitive Battlecard Framework 1,278 words, Dunford's 10-Step Positioning Process 1,380 words, GTM Strategy vs Product Marketing primer 921 words, GTM Motion Model 1,526 words, JTBD Switch Interview Method 1,327 words, Product-Led Growth 1,321 words, Conjoint Analysis 1,514 words, Buyer's Journey Content Map 1,366 words, ICP Development Methodology 1,479 words, Kano Model 1,394 words)
- Entries with cross-references to other entries: 38/38 ✅ (100%; all twelve new entries carry four or more See-also links)
- Frameworks with Further Reading sections (established only): 6/6 ✅ (100%)
- Entries with metrics benchmarks or explicit success metrics: 38/38 ✅ (100%; all twelve new entries name explicit success metrics or measures)
- Entries with actionable pitfall recovery steps: 37/38 ✅ (the primer carries no Pitfalls section per CLAUDE.md's Primer template; the other 37 each carry pitfalls with recovery steps)
- Entries validated against web sources: 19/38 ✅ (the 19 original frameworks were validated 2026-04-09; the 19 added since, Category 8's 4 pricing entries, the Product Differentiation recount, and the 12 entries added 2026-07-21/22/23, have not had a separate source-validation pass)
- Attribution accuracy verified: 19/19 of the original set ✅ (100%; 2 errors fixed 2026-04-09); Category 8 and the 2026-07-21/22/23 entries are converged-practice or single-sourced, cited inline (Message Architecture: Pragmatic Institute / PMA; VoC: Griffin & Hauser 1993; Competitive Battlecard: converged practice, Crayon/Klue/PMA; Dunford's 10-Step Process: April Dunford, *Obviously Awesome*, 2019; GTM Motion Model: converged practice, OpenView/Bessemer/Winning by Design; JTBD Switch Interview Method: Bob Moesta and Chris Spiek, The Re-Wired Group; Product-Led Growth: Wes Bush, *Product-Led Growth*, 2019, and OpenView Partners; Conjoint Analysis: Paul Green and V. Srinivasan, 1970s; Buyer's Journey Content Map: converged content-marketing and enablement practice; ICP Development Methodology: converged practice, demandbase/HubSpot/ABM literature; Kano Model: Noriaki Kano, 1984) rather than uniformly attributed to a single named originator; the GTM vs PMM primer is an original KB explainer with no external originator to attribute
- Em dashes in entry content: 0/38 ✅ (fixed 2026-07-19; all twelve new entries written em-dash-free)
- British English spelling compliance: 38/38 ✅ (all twelve new entries written in British English)
...
0. **Build out [ENRICHMENT-PLAN.md](ENRICHMENT-PLAN.md) (logged 2026-07-21; build approved; 12 of 19 built).** All five "High" candidates are done: A11 Message Architecture (Category 2), A6 Voice of the Customer Programme (Category 1), A17 Competitive Battlecard Framework (Category 3), A9 Dunford's 10-Step Positioning Process (Category 2), and A5 the GTM Strategy vs Product Marketing primer (new `concepts/` area). Seven "Medium" candidates are also done: A1 GTM Motion Model (Category 4), A2 Product-Led Growth (Category 4), A7 JTBD Switch Interview Method (Category 1), A14 Conjoint Analysis (Category 8), A18 Buyer's Journey Content Map (Category 5), A3 ICP Development Methodology (Category 1), and A8 Kano Model (Category 6). The remaining 7 candidate frameworks and methodologies (Command of the Message, and the six "Lower" candidates) will be built and added to the system, starting with A13 Command of the Message, the last "Medium"-priority candidate, then working top-down through the "Lower" priority tier; the priority column in the plan is the build order, not a filter. Stand up a new Category 9 (Sales Enablement) once A19 joins A17 (Category 3) and A18 (Category 5) there. Still outstanding from Part B: the `**Type:**` backfill on the original 26 entries and the Type-column rollout across all INDEX.md and README.md tables (the twelve new entries are typed in their files and inline in INDEX.md).
